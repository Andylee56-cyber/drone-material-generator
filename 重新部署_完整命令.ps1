# ========================================
# 重新部署修复后的代码到GitHub和Streamlit Cloud
# ========================================

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "📤 步骤1：更新 material_generator_app.py" -ForegroundColor Yellow
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# 保存代码到文件
$appCode | Set-Content "app\web\material_generator_app.py" -Encoding UTF8
Write-Host "✅ material_generator_app.py 已更新" -ForegroundColor Green
Write-Host ""
